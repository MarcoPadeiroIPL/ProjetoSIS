...
INSERT INTO `airplanes` (`id`, `luggageCapacity`, `minLinha`, `minCol`, `maxLinha`, `maxCol`, `economicStart`, `economicStop`, `normalStart`, `normalStop`, `luxuryStart`, `luxuryStop`, `status`) VALUES
...
INSERT INTO `airports` (`id`, `country`, `code`, `city`, `search`, `status`) VALUES
...
INSERT INTO `clients` (`user_id`, `balance`, `application`) VALUES
(8, 990.00, 1),
(9, 42.00, 1),
(10, 970.00, 0),
(11, 481.00, 1),
...
INSERT INTO `configs` (`id`, `description`, `weight`, `price`, `active`) VALUES
...
INSERT INTO `employees` (`user_id`, `salary`, `airport_id`) VALUES
(68, 2483.00, 5),
(69, 1787.00, 21),
(70, 2190.00, 8),
(71, 2367.00, 25),
...
INSERT INTO `userData` (`user_id`, `fName`, `surname`, `birthdate`, `phone`, `nif`, `gender`, `accCreationDate`) VALUES
...
--
-- Indexes for table `balanceReq`
--
ALTER TABLE `balanceReq`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_client_id` (`client_id`);

--
-- Indexes for table `balanceReq_employee`
--
ALTER TABLE `balanceReq_employee`
  ADD PRIMARY KEY (`balanceReq_id`),
  ADD KEY `fk_employeeBalanceReq_id` (`employee_id`);
...
ALTER TABLE `employees`
  ADD PRIMARY KEY (`user_id`),
  ADD KEY `fk_airport_id` (`airport_id`);
...
ALTER TABLE `flights`
  ...
  ADD KEY `fk_airportDeparture_id` (`airportDeparture_id`),
  ADD KEY `fk_airportArrival_id` (`airportArrival_id`);
...
ALTER TABLE `receipts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_clientTicket_id` (`client_id`);
...
ALTER TABLE `refund`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_receiptRefund_id` (`receipt_id`);

--
-- Indexes for table `refund_employee`
--
ALTER TABLE `refund_employee`
  ADD PRIMARY KEY (`refund_id`),
  ADD KEY `fk_refundEmployee_id` (`employee_id`);
...
ALTER TABLE `tariffs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_flightTariff_id` (`flight_id`);
...
ALTER TABLE `tickets`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_employeeTicket_id` (`checkedIn`),
  ADD KEY `fk_clientTicket_id` (`client_id`),
  ADD KEY `fk_flight_id` (`flight_id`),
  ADD KEY `fk_luggage_1` (`luggage_1`),
  ADD KEY `fk_luggage_2` (`luggage_2`),
...
--
-- AUTO_INCREMENT for table `balanceReq`
--
ALTER TABLE `balanceReq`
...
--
-- Constraints for table `balanceReq`
--
ALTER TABLE `balanceReq`
  ADD CONSTRAINT `fk_client_id` FOREIGN KEY (`client_id`) REFERENCES `clients` (`user_id`);

--
-- Constraints for table `balanceReq_employee`
--
ALTER TABLE `balanceReq_employee`
  ADD CONSTRAINT `fk_balanceReq_id` FOREIGN KEY (`balanceReq_id`) REFERENCES `balanceReq` (`id`),
  ADD CONSTRAINT `fk_employeeBalanceReq_id` FOREIGN KEY (`employee_id`) REFERENCES `user` (`id`);

--
-- Constraints for table `clients`
--
ALTER TABLE `clients`
  ADD CONSTRAINT `fk_usersClients_id` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);

--
-- Constraints for table `employees`
--
ALTER TABLE `employees`
  ADD CONSTRAINT `fk_airport_id` FOREIGN KEY (`airport_id`) REFERENCES `airports` (`id`),
  ADD CONSTRAINT `fk_usersEmployees_id` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);

--
-- Constraints for table `flights`
--
ALTER TABLE `flights`
  ADD CONSTRAINT `fk_airplane_id` FOREIGN KEY (`airplane_id`) REFERENCES `airplanes` (`id`),
  ADD CONSTRAINT `fk_airportArrival_id` FOREIGN KEY (`airportArrival_id`) REFERENCES `airports` (`id`),
  ADD CONSTRAINT `fk_airportDeparture_id` FOREIGN KEY (`airportDeparture_id`) REFERENCES `airports` (`id`);

--
-- Constraints for table `receipts`
--
ALTER TABLE `receipts`
  ADD CONSTRAINT `fk_clientReceipt_id` FOREIGN KEY (`client_id`) REFERENCES `clients` (`user_id`);

--
-- Constraints for table `refund`
--
ALTER TABLE `refund`
  ADD CONSTRAINT `fk_receiptRefund_id` FOREIGN KEY (`receipt_id`) REFERENCES `receipt` (`id`);

--
-- Constraints for table `refund_employee`
--
ALTER TABLE `refund_employee`
  ADD CONSTRAINT `fk_refundEmployee_id` FOREIGN KEY (`employee_id`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `fk_refund_id` FOREIGN KEY (`refund_id`) REFERENCES `refund` (`id`);

--
-- Constraints for table `tariffs`
--
ALTER TABLE `tariffs`
  ADD CONSTRAINT `fk_flightTariff_id` FOREIGN KEY (`flight_id`) REFERENCES `flights` (`id`);

--
-- Constraints for table `tickets`
--
ALTER TABLE `tickets`
  ADD CONSTRAINT `fk_clientTicket_id` FOREIGN KEY (`client_id`) REFERENCES `clients` (`user_id`),
  ADD CONSTRAINT `fk_employeeTicket_id` FOREIGN KEY (`checkedIn`) REFERENCES `employees` (`user_id`),
  ADD CONSTRAINT `fk_flight_id` FOREIGN KEY (`flight_id`) REFERENCES `flights` (`id`),
  ADD CONSTRAINT `fk_luggage_1` FOREIGN KEY (`luggage_1`) REFERENCES `configs` (`id`),
  ADD CONSTRAINT `fk_luggage_2` FOREIGN KEY (`luggage_2`) REFERENCES `configs` (`id`),
  ADD CONSTRAINT `fk_receipt_id` FOREIGN KEY (`receipt_id`) REFERENCES `receipts` (`id`),
  ADD CONSTRAINT `fk_tariff_id` FOREIGN KEY (`tariff_id`) REFERENCES `tariffs` (`id`);

--
-- Constraints for table `userData`
--
ALTER TABLE `userData`
  ADD CONSTRAINT `fk_userData_id` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);
COMMIT;
